...
@section('isi')
    @if (Auth::user()->role == 'admin')
        <a href="{{ route('halaman_tambahSPMPokok') }}" class="section btn btn-info"><i class="fa fa-plus-circle"></i>
            Tambah
            Bukti Pembayaran</a>
        <a href="{{ route('printSPMP') }}" class="btn btn-danger" target="_blank"><i class="fas fa-print"></i> Print
            PDF</a>
    @else
        <a href="{{ route('AgPrintPokok') }}" class="btn btn-danger" target="_blank"><i class="fas fa-print"></i> Print
            PDF</a>
    @endif
    <hr>
    <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Table Simpanan Pokok</h4> <span class="badge badge-danger">{{ $jumlahData }}</span>
                </div>
                <div class="card-body">
                                    ...
                                    @foreach ($setoran as $no => $set)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->role == 'admin')
                                                    <a href="{{ route('halaman_editSPMPokok', $set->id) }}"><i
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('hapus_spm') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <p>Apakah Anda Yakin Ingin Menghapus Setoran Pokok dari <b>{{ $set->name }}</b>!</p>
                            </div>
                    </div>
