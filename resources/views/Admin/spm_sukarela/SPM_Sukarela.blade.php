...
@section('judul', 'Simpanan Sukarela')
...
@section('isi')
    @if (Auth::user()->role == 'admin')
        <a href="{{ route('halaman_tambahSPMSukarela') }}" class="section btn btn-info"><i class="fa fa-plus-circle"></i>
            Tambah
            Bukti Pembayaran</a>
        <a href="{{ route('printSPMS') }}" class="btn btn-danger" target="_blank"><i class="fas fa-print"></i> Print
            PDF</a>
    @else
        <a href="{{ route('AgPrintSukarela') }}" class="btn btn-danger" target="_blank"><i class="fas fa-print"></i> Print
            PDF</a>
    @endif
    <hr>
    <div class="row">
        {{-- Table Simpanan Sukarela --}}
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Table Simpanan Sukarela</h4> <span class="badge badge-danger">{{ $jumlahData }}</span>
                </div>
                <div class="card-body">
                                    ...
                                    @foreach ($setoran as $no => $set)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (Auth::user()->role == 'admin')
                                                    <a href="{{ route('halaman_editSPMSukarela', $set->id) }}"><i
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <img src="{{ asset('Gambar/Admin/Simpanan Wajib/' . $ser->gambar_setoran) }}" with="300"
                                    height="300" alt="">
                            </div>
                    </div>
                    </form>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('hapus_spm') }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="key_simpanan" value="3">
                            <div class="form-group">
                                <p>Apakah Anda Yakin Ingin Menghapus Setoran Sukarela dari <b>{{ $set->name }}</b>!</p>
                            </div>
                    </div>
