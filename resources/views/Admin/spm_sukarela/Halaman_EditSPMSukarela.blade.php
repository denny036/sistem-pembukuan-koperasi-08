...
@section('title', 'Edit Simpanan Sukarela - Admin')
@section('judul', 'Edit Simpanan Sukarela')
...
@section('isi')
    <a href="{{ route('simpanan_sukarela') }}" class="section btn btn-info"><i class="fas fa-arrow-circle-left"></i>
        Kembali</a>
    <hr>
    <div class="row">
                                ...
                                <form action="{{ route('edit_spmData') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-6">
                                                <label @error('tahun') class="text-danger" role="alert" @enderror> Tahun
                                                    @error('tahun')
                                                        | {{ $message }}
                                                    @enderror
                                                </label>
                                                <input type="number" name="tahun"
                                                    @if (old($ser->tahun)) value="{{ old('tahun') }}"
                                                @else
                                                    value="{{ $ser->tahun }}" @endif
                                                    class="form-control">
                                            </div>
                                        </div>
                                    </div>
