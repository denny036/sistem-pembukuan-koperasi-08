...
@section('judul', 'Semua Pembayaran')
...
@section('isi')
    <a href="{{ route('printAllPembayaran') }}" class="btn btn-danger" target="_blank"><i class="fas fa-print"></i> Print PDF</a>
        ...
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Semua Daftar Pembayaran</h4> {{-- <span class="badge badge-danger">{{ $jumlahData }}</span> --}}
                </div>
                <div class="card-body">
                            ...
                            <table id="example" class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">Untuk pinjaman pada</th>
